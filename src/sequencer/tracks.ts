...
export const TRACK_DEFS: TrackDef[] = [
  ...
  { name: 'Sample 1', shortName: 'S1', sampleUrl: '',                     melodic: true, custom: true },
  { name: 'Sample 2', shortName: 'S2', sampleUrl: '',                     melodic: true, custom: true },
  { name: 'Sample 3', shortName: 'S3', sampleUrl: '',                     melodic: true, custom: true },
  { name: 'Sample 4', shortName: 'S4', sampleUrl: '',                     melodic: true, custom: true },
  { name: 'Sample 5', shortName: 'S5', sampleUrl: '',                     melodic: true, custom: true },
  { name: 'Sample 6', shortName: 'S6', sampleUrl: '',                     melodic: true, custom: true },
  { name: 'Sample 7', shortName: 'S7', sampleUrl: '',                     melodic: true, custom: true },
  { name: 'Sample 8', shortName: 'S8', sampleUrl: '',                     melodic: true, custom: true },
];
